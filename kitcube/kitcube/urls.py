...
urlpatterns = patterns('',
    ...
    url(r'^initprojconf/$', InitializeFirstTimeListsView.as_view()),
    url(r'^updateprojconf/$', UpdateProjConfListsView.as_view()),
    url(r'^katrin/projectinfo/', ProjectDetailView.as_view(), {'projname' : 'katrin'}),
    url(r'^kitcube/projectinfo/', ProjectDetailView.as_view(), {'projname' : 'kitcube'}),
    url(r'^katrin/configs/$', ConfigListView.as_view(), {'projname' : 'katrin'}),
    url(r'^katrin/configs/(?P<confname>\w+)/$', ConfigDetailView.as_view(), {'projname' : 'katrin'}),
    url(r'^kitcube/configs/$', ConfigListView.as_view(), {'projname' : 'kitcube'}),
    url(r'^kitcube/configs/(?P<confname>\w+)/$', ConfigDetailView.as_view(), {'projname' : 'kitcube'}),
